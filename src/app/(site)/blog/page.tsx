  ...
  return (
    <div className="glass-card overflow-hidden animate-pulse flex flex-col">
      ...
      <div className="p-5 space-y-3">
        ...
        <div className="h-4 rounded w-4/5" style={{ background: "rgba(30,30,50,0.8)" }} />
        ...
        <div className="h-8 rounded mt-2" style={{ background: "rgba(30,30,50,0.8)" }} />
      </div>
    </div>
  );
}
      ...
      <section className="sticky top-16 z-30 backdrop-blur-2xl py-3.5 px-4"
        ...
        <div className="max-w-6xl mx-auto flex flex-col sm:flex-row gap-3 items-center justify-between">
          <div className="flex items-center gap-1.5 overflow-x-auto hide-scrollbar w-full sm:w-auto">
            {[{ slug: "all", name: "All Posts" }, ...categories].map((cat) => {
